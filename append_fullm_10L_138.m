...
list = dir('C:\Users\Jun Young\Desktop\ImageData\CMH\CMH5\*.jpg'); 
numfiles = size(list,1);
%o = 3;
for o = 2:28 %numfiles %10번파일 40번부터 엑셀값다시
    
    fn = strcat('C:\Users\Jun Young\Desktop\ImageData\CMH\CMH5','\',list(o).name);
...
% imagename = strcat(int2str(o),'.bmp');
% name = strcat('C:\Users\Jun Young\Desktop\ImageData\D\D12\im10_gt\result\','\',imagename);
% imwrite(final_image,name);

%% FPR, TPR
gtlist = dir('C:\Users\Jun Young\Desktop\ImageData\CMH\CMH5_gt\*.png'); %jpeg 5는jpg
gtfn = strcat('C:\Users\Jun Young\Desktop\ImageData\CMH\CMH5_gt','\',gtlist(o).name);
gt = imread(gtfn);
%gt = rgb2gray(gt);
fi = final_image;
gt = im2bw(gt,0.5);
