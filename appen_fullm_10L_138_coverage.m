%% Min Variation + New Descriptor(138 with 10LBP) COVERAGE 
clear all
close all
...
list = dir('C:\Users\Jun Young\Desktop\ImageData\Coverage\temper\*.tif'); 
numfiles = size(list,1);
o = 64;
%for o = 100:numfiles %1번,2다시,19번다시,30,50,51,52다시 H부족은 클러현상
    
    fn = strcat('C:\Users\Jun Young\Desktop\ImageData\Coverage\temper','\',list(o).name);
...
%imagename = strcat(int2str(o),'.tif');
%name = strcat('C:\Users\Jun Young\Desktop\ImageData\Coverage\result\','\',imagename);
%imwrite(final_image,name);

%% FPR, TPR

gtlist1 = dir('C:\Users\Jun Young\Desktop\ImageData\Coverage\gt\Copy\*.tif'); %jpeg 5는jpg
gtfn1 = strcat('C:\Users\Jun Young\Desktop\ImageData\Coverage\gt\Copy','\',gtlist1(o).name);
gt1 = imread(gtfn1);
gt1 = im2bw(gt1,0.5);
gtlist2 = dir('C:\Users\Jun Young\Desktop\ImageData\Coverage\gt\forged\*.tif'); %jpeg 5는jpg
gtfn2 = strcat('C:\Users\Jun Young\Desktop\ImageData\Coverage\gt\forged','\',gtlist2(o).name);
gt2 = imread(gtfn2);
gt2 = im2bw(gt2,0.5);
...
%end
%filename = 'testdata_coverage10.xlsx';
